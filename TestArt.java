...
public class TestArt extends JFrame {
	public static void main(String[] args) {
		try {
			...
			TestArt frame = new TestArt(args[0], args[1]);
	...
	public TestArt(String idxFile, String artFile) throws IOException {
		cache = new ArtLoader(new RandomAccessFile(idxFile, "r").getChannel(),
